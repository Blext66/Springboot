...
public class PersonaController {
    ...
    //La clase model se usa para transferir objetos del controller a la vista
    @GetMapping
    ...
    @GetMapping("/nueva")
    public String mostraFormularioDeNuevaPersona(Model model) {
    ...
    public String mostraFormularioEditarPersona(@PathVariable Long id,@ModelAttribute Persona persona, Model model) {
